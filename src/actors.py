...
events_act2_df = withColumnRenamed(events_act2_df, "Actor2Name", "Actor1Name")
events_act2_df = withColumnRenamed(events_act2_df, "Actor2Type1Code", "Actor1Type1Code")
events_act2_df = withColumnRenamed(events_act2_df, "Actor2Type2Code", "Actor1Type2Code")
events_act2_df = withColumnRenamed(events_act2_df, "Actor2Type3Code", "Actor1Type3Code")
