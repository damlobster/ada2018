...
from load_datasets import load_gkg, load_mentions, load_events
...
if step == "GKG":
    ...
    gkg_df = spark.read.parquet(config.OUTPUT_PATH+"/gkg_small.parquet").selectExpr("V2DocumentIdentifier as MentionIdentifier")
